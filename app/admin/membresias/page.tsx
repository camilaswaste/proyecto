  ...
  const fetchPlanes = async () => {
    try {
      ...
      toast({
        variant: "error",
        title: "Error",
        description: "Error de red al cargar membresías.",
      })
    } finally {
      setLoading(false)
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          variant: "success",
          title: "Guardado",
          description: editingPlan ? "Plan actualizado correctamente." : "Plan creado correctamente.",
        })
      } else {
        ...
        toast({
          variant: "error",
          title: "Error",
          description: errJson?.error || "No se pudo guardar el plan.",
        })
      }
    } catch (error) {
      ...
      toast({
        variant: "error",
        title: "Error",
        description: "Error de red al guardar el plan.",
      })
    }
  }
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          variant: "error",
          title: "Error",
          description: errJson?.error || "No se pudo eliminar el plan.",
        })
      }
    } catch (error) {
      ...
      toast({
        variant: "error",
        title: "Error",
        description: "Error de red al eliminar el plan.",
      })
    }
  }
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-background">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.ofertas}</div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <select
                  ...
                  className="min-w-[180px] rounded-md border border-border bg-background px-4 py-2 text-foreground shadow-sm outline-none focus:ring-2 focus:ring-ring"
                >
                        ...
                        paginatedPlanes.map((plan) => (
                          <tr
                            ...
                            className={[
                              ...
                              plan.TipoPlan === "Oferta"
                                ? "bg-gradient-to-r from-amber-50/50 to-transparent dark:from-amber-950/25 dark:to-transparent"
                                : "",
                            ].join(" ")}
                          >
                            <td className="p-3">
                              <div className="flex items-center gap-2">
                                <span className="font-medium text-foreground">{plan.NombrePlan}</span>
                                ...
                                {plan.TipoPlan === "Oferta" && plan.FechaFinOferta && (
                                  <div className="flex items-center gap-1">
                                    ...
                                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-950/40 dark:text-red-200">
                            ...
                            <td className="p-3">
                              {plan.TipoPlan === "Oferta" && plan.PrecioOriginal ? (
                                ...
                                <span className="text-foreground">${plan.Precio.toLocaleString()}</span>
                              )}
                            </td>

                            <td className="p-3 text-foreground">{plan.DuracionDias} días</td>
                            ...
                            <td className="p-3">
                              <span
                                className={[
                                  ...
                                  plan.Activo
                                    ? "bg-green-100 text-green-800 border-green-200 dark:bg-green-950/35 dark:text-green-200 dark:border-green-900/40"
                                    : "bg-muted text-foreground border-border dark:bg-white/5",
                                ].join(" ")}
                              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5 mt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-md border border-border p-2 mt-1.5 bg-background text-foreground shadow-sm outline-none focus:ring-2 focus:ring-ring"
                  >
                    <option value="Normal">Normal</option>
                    <option value="Oferta">🎉 Oferta Especial</option>
                  </select>
                ...
                {formData.tipoPlan === "Oferta" && (
                  <div className="md:col-span-2">
                    <div className="p-4 border-2 border-amber-200 dark:border-amber-900/40 rounded-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/25 dark:to-orange-950/15 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <div className="mt-1.5 p-2 bg-background border border-border rounded-md">
                      ...
                      {formData.descuento && formData.precioOriginal && (
                        <div className="p-3 bg-background rounded-md border border-amber-200 dark:border-amber-900/40">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-border p-3 min-h-[100px] mt-1.5 bg-background text-foreground shadow-sm outline-none focus:ring-2 focus:ring-ring"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-border p-3 min-h-[120px] mt-1.5 bg-background text-foreground shadow-sm outline-none focus:ring-2 focus:ring-ring"
