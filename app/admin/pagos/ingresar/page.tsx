        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <Link href="/admin/pagos">
              <Button variant="ghost" className="mb-2 hover:bg-white/80 transition-colors">
                <ArrowLeft className="h-4 w-4 mr-2" />
                Volver a Pagos
              </Button>
            </Link>
            <h1 className="text-3xl font-bold tracking-tight text-balance">Ingresar Pago Manual</h1>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {filteredSocios.map((socio) => {
                  ...
                  return (
                    <Card
                      key={socio.SocioID}
                      className={`group relative overflow-hidden border-2 transition-all duration-200 cursor-pointer ${
                        selectedSocio === socio.SocioID
                          ? "border-blue-500 bg-blue-50/50 shadow-lg scale-[1.02]"
                          : "border-border hover:border-blue-300 hover:shadow-md hover:scale-[1.01]"
                      }`}
                    ...
                    >
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {selectedSocio === socio.SocioID && (
                            <CheckCircle2 className="h-6 w-6 text-blue-600 animate-in fade-in zoom-in duration-200 shrink-0" />
                          )}
                        </div>
                      </CardHeader>
                      ...
                      <CardContent className="space-y-3">
                        <div className="flex items-center justify-between p-3 rounded-lg bg-muted/40">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold text-blue-600">{formatCurrency(socio.Precio)}</p>
                          </div>
                        </div>
