...
export default function SocioDashboardPage() {
  ...
  return (
    <DashboardLayout role="Socio">
      <div className="relative overflow-hidden rounded-xl bg-slate-800 p-8 mb-8 shadow-lg border border-slate-700">
        <div className="relative z-10 flex items-center justify-between">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-white tracking-tight">Hola, {membershipData?.nombre}!</h1>
            <p className="text-slate-300 text-lg">Bienvenido a Mundo Fitness Chimbarongo</p>
            <div className="flex items-center gap-2 mt-4">
              <Clock className="h-5 w-5 text-white" />
              <span className="text-white font-medium">Gimnasio {isGymOpen ? "ABIERTO" : "CERRADO"} ahora</span>
              <div className={`h-3 w-3 rounded-full ${isGymOpen ? "bg-emerald-400" : "bg-slate-400"} animate-pulse`} />
            </div>
          </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card className="border border-slate-200 shadow-lg overflow-hidden">
            ...
            <CardContent className="pt-6 bg-white">
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div className="text-center p-4 rounded-lg bg-slate-100 border border-slate-300">
                  <p className="text-sm text-slate-700 font-medium mb-1">Plan Actual</p>
                  <p className="text-2xl font-bold text-slate-900">{membershipData?.plan || "Sin plan"}</p>
                </div>
                <div className="text-center p-4 rounded-lg bg-red-50 border border-red-300">
                  <p className="text-sm text-red-700 font-medium mb-1">Vence</p>
                  <p className="text-lg font-bold text-red-900">{membershipData?.fechaVencimiento || "N/A"}</p>
                </div>
                <div className="text-center p-4 rounded-lg bg-emerald-50 border border-emerald-300">
                  <p className="text-sm text-emerald-700 font-medium mb-1">Días Restantes</p>
              ...
              <div className="flex gap-3">
                <Link href="/socio/membresia" className="flex-1">
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-lg py-6 shadow-md hover:shadow-lg transition-all">
                ...
                <Button
                  ...
                  className="px-8 py-6 border-2 border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-slate-400 transition-all"
                >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link href="/socio/entrenadores">
              <Card className="h-full hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer border border-slate-200 hover:border-red-400 group bg-white">
                <CardContent className="pt-6 flex items-center gap-4">
                  <div className="p-4 bg-red-600 rounded-lg group-hover:bg-red-700 transition-all shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Con entrenador personal</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/socio/pagos">
              <Card className="h-full hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer border border-slate-200 hover:border-slate-400 group bg-white">
                <CardContent className="pt-6 flex items-center gap-4">
                  <div className="p-4 bg-slate-700 rounded-lg group-hover:bg-slate-800 transition-all shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Renueva tu membresía</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
          ...
          <Card className="shadow-md border border-slate-200 bg-white">
            <CardHeader>
              ...
              <CardDescription>Sesiones y clases programadas</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center gap-4 p-4 border border-slate-200 rounded-lg bg-white hover:border-red-300 hover:bg-red-50/50 transition-all">
                  <div className="flex flex-col items-center justify-center bg-red-600 text-white rounded-lg p-3 min-w-[70px] shadow-sm">
                    <span className="text-2xl font-bold">22</span>
                    <span className="text-xs">ENE</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-bold text-lg text-slate-900">Sesión Personal</p>
                    <p className="text-sm text-slate-600">11:00 AM - Con Pedro Martínez</p>
                  </div>
                  <Badge className="bg-red-600 hover:bg-red-700">Confirmada</Badge>
                </div>
                <div className="flex items-center gap-4 p-4 border border-slate-200 rounded-lg bg-white hover:border-slate-300 hover:bg-slate-50 transition-all">
                  <div className="flex flex-col items-center justify-center bg-slate-700 text-white rounded-lg p-3 min-w-[70px] shadow-sm">
                    <span className="text-2xl font-bold">23</span>
                    <span className="text-xs">ENE</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-bold text-lg text-slate-900">Clase Funcional</p>
                    <p className="text-sm text-slate-600">6:00 PM - Grupal</p>
                  </div>
                  <Badge className="bg-slate-700 hover:bg-slate-800">Reservada</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          <Card className="border border-slate-200 shadow-lg sticky top-4 bg-white">
            <div className="h-1 bg-red-600" />
            <CardHeader className="bg-slate-50 pb-3">
              <CardTitle className="text-slate-900 text-xl">Mundo Fitness</CardTitle>
              <CardDescription className="text-slate-600 font-medium">Información de Contacto</CardDescription>
            </CardHeader>
            <CardContent className="pt-4 space-y-3">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-slate-900 group-hover:text-pink-600">Instagram</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-slate-900 group-hover:text-teal-600">Ubicación</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-slate-900 group-hover:text-slate-700">Email</p>
              ...
              <Link href="/socio/horarios" className="block">
                <Button
                  variant="outline"
                  className="w-full justify-start border-2 border-slate-300 text-slate-700 hover:bg-slate-50 hover:border-slate-400 font-medium transition-all bg-transparent"
                >
      ...
      {avisosNoLeidos > 0 && (
        <button
          ...
          className="fixed bottom-8 right-8 bg-red-600 hover:bg-red-700 text-white rounded-lg px-6 py-4 shadow-xl hover:shadow-2xl transition-all hover:scale-105 z-50 group flex items-center gap-3 font-semibold border border-red-700"
        >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-medium">{membershipData?.plan || "Sin plan"}</p>
                </div>

                <div>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider mb-1">Vigencia</p>
                  <p className="text-white text-lg font-medium">Hasta {membershipData?.fechaVencimiento || "N/A"}</p>
                </div>
              </div>
